...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/backgroundDark.png", __ASSET__assets_images_backgrounddark_png);
		type.set ("assets/images/backgroundDark.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("assets/images/ScreenShot.png", __ASSET__assets_images_screenshot_png);
		type.set ("assets/images/ScreenShot.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/music/music-goes-here.txt", __ASSET__assets_music_music_goes_here_txt);
		type.set ("assets/music/music-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("assets/sounds/BallHit.ogg", __ASSET__assets_sounds_ballhit_ogg);
		type.set ("assets/sounds/BallHit.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/Hit_Hurt.wav", __ASSET__assets_sounds_hit_hurt_wav);
		type.set ("assets/sounds/Hit_Hurt.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/sounds-go-here.txt", __ASSET__assets_sounds_sounds_go_here_txt);
		type.set ("assets/sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("Hit", __ASSET__assets_sounds_hit_hurt_wav1);
		...
		type.set ("assets/images/background2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/backgroundDark.png", "assets/images/backgroundDark.png");
		type.set ("assets/images/backgroundDark.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/explosion.png", "assets/images/explosion.png");
		type.set ("assets/images/explosion.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/images/ScreenShot.png", "assets/images/ScreenShot.png");
		type.set ("assets/images/ScreenShot.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/music/music-goes-here.txt", "assets/music/music-goes-here.txt");
		type.set ("assets/music/music-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/sounds/BallHit.ogg", "assets/sounds/BallHit.ogg");
		type.set ("assets/sounds/BallHit.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/Hit_Hurt.wav", "assets/sounds/Hit_Hurt.wav");
		type.set ("assets/sounds/Hit_Hurt.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/sounds-go-here.txt", "assets/sounds/sounds-go-here.txt");
		type.set ("assets/sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("Hit", "assets/sounds/Hit_Hurt.wav");
		type.set ("Hit", Reflect.field (AssetType, "sound".toUpperCase ()));
...
class __ASSET__assets_images_background2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_backgrounddark_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_explosion_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
class __ASSET__assets_images_screenshot_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_music_music_goes_here_txt extends flash.utils.ByteArray { }
class __ASSET__assets_sounds_ballhit_ogg extends flash.media.Sound { }
class __ASSET__assets_sounds_hit_hurt_wav extends flash.media.Sound { }
class __ASSET__assets_sounds_sounds_go_here_txt extends flash.utils.ByteArray { }
class __ASSET__assets_sounds_hit_hurt_wav1 extends flash.media.Sound { }
